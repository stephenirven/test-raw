...
Interpreter.prototype.pseudoToNative = function (pseudoObj, opt_cycles) {
  ...
  if (this.isa(pseudoObj, this.REGEXP)) {
    ...
    nativeRegExp.__uniqueid = Object.id(pseudoObj); // UID mod
  ...
  if (this.isa(pseudoObj, this.DATE)) {
    ...
    nativeDate.__uniqueid = Object.id(pseudoObj); // UID mod
  ...
  if (
    ...
    nativeBox.__uniqueid = Object.id(pseudoObj); // UID mod
  ...
  nativeObj.__uniqueid = Object.id(pseudoObj); // UID mod
