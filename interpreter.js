...
Interpreter.prototype.pseudoToNative = function (pseudoObj, opt_cycles) {
  ...
  if (
    ...
    for (let key in pseudoVals) {
      nativeObj.add(this.pseudoToNative(pseudoVals[key], cycles));
    }
    cycles.native.push(nativeObj);
    return nativeObj;
  }
  ...
  if (
    ...
    for (let arrayKey in pseudoKeys) {
      ...
      const val = this.pseudoToNative(pseudoVals[arrayKey], cycles);
  ...
  nativeObj.__uniqueid = Object.id(pseudoObj); // ADDED to supportunique object IDs
